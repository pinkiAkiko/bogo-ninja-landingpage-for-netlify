...
export default function BogoNinjaLanding() {
  ...
  const steps = [
    ...
    },
    {
      ...
      desc: "Discover restaurants around you instantly",
      image: "/step02.svg",
    },
    {
      icon: <Smartphone className="w-8 h-8 text-bogo-orange-600" />,
      title: "Grab a Coupon",
      desc: "Tap, save, and show at checkout",
      image: "/step03.svg",
    },
    {
      icon: <Utensils className="w-8 h-8 text-bogo-orange-600" />,
      title: "Redeem & Dine",
      desc: " Enjoy instant savings, no hidden fees",
      image: "/step04.svg",
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-bogo-orange-50 to-bogo-dark-50">
            ...
            <div className="space-y-8 text-center lg:text-left">
              <div className="space-y-4">
                <h1 className="text-5xl lg:text-6xl font-bold leading-tight">
                  ...
                  . Dine More, Spend Less.
                </h1>
                <p className="text-xl text-gray-600 leading-relaxed">
                  Enjoy instant savings from restaurants near you — no fees, no gimmicks, just real discounts.
                </p>
              </div>
              ...
              <div className="flex flex-col sm:flex-row justify-center lg:justify-start gap-4">
                ...
                <a
                  href="https://portal.bogoninja.com"
                  target="_blank"
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl sm:text-4xl font-bold mb-4">
              Trusted by Local Restaurants & Food Lovers
            </h2>
            <p className="text-gray-600 text-base sm:text-lg">
              Partnering with top dining spots to bring you unbeatable deals.
            </p>
          </div>
          ...
          <div className="text-center mt-8">
            <Button
              variant="outline"
              className="whitespace-normal break-words text-sm sm:text-base px-4 py-4"
              onClick={() => scrollToSection("partners")}
            >
              Showcase your restaurant to thousands of nearby diners. Partner With Us Free.
            </Button>
          </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="relative">
            <div className="flex overflow-x-auto gap-4 sm:gap-6 md:gap-8 scroll-smooth scrollbar-hide px-1 md:grid md:grid-cols-2 lg:grid-cols-3 md:overflow-visible">
              {/* Card 1 */}
              <Card className="flex-shrink-0 w-[280px] sm:w-auto p-6 hover:shadow-lg hover:bg-bogo-orange-50 transition-shadow">
              ...
              <Card className="flex-shrink-0 w-[280px] sm:w-auto p-6 hover:shadow-lg hover:bg-bogo-orange-50 transition-shadow">
                <CardContent className="p-0">
                  ...
                  <p className="text-gray-600">Tap, grab, and dine with ease</p>
                </CardContent>
              </Card>
              ...
              <Card className="flex-shrink-0 w-[280px] sm:w-auto p-6 hover:shadow-lg hover:bg-bogo-orange-50 transition-shadow">
                <CardContent className="p-0">
                  ...
                  <p className="text-gray-600">Personalized deals in your neighborhood</p>
                </CardContent>
              </Card>
              ...
              <Card className="flex-shrink-0 w-[280px] sm:w-auto p-6 hover:shadow-lg hover:bg-bogo-orange-50 transition-shadow">
                <CardContent className="p-0">
                  ...
                  <p className="text-gray-600">Zero fees, zero subscriptions</p>
                </CardContent>
              </Card>
              ...
              <Card className="flex-shrink-0 w-[280px] sm:w-auto p-6 hover:shadow-lg hover:bg-bogo-orange-50 transition-shadow">
                <CardContent className="p-0">
                  ...
                  <p className="text-gray-600">Safe, private, and trusted</p>
                </CardContent>
              </Card>
            </div>
          </div>
      ...
      {/* <div id="deals" className="bg-gray-50"> </div> */}
      {/* Top Deals */}
      {/* <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold mb-4">Trending Deals Near You</h2>
            <p className="text-gray-600 text-lg">Grab These Hot Deals Before They’re Gone! </p>
          </div>
                      ...
                      <div>
                        ...
                        <div className="flex text-yellow-400">
                          {[...Array(5)].map((_, i) => (
                            <Star
                              key={i}
                              className={`w-3.5 h-3.5 fill-current ${i < f.rating ? "" : "text-gray-300"
                                }`}
                            />
                          ))}
                        </div>
      ...
      <section className="relative py-16 bg-bogo-dark-500 text-white overflow-hidden">
        <Image
          src="/food01.png"
          alt="Floating plate"
          width={280}
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold mb-4">Calling All Restaurants – Get Free Customers Today</h2>
            <p className="text-xl opacity-90 max-w-3xl mx-auto">
              Get discovered by thousands of nearby diners — completely free. Grow your sales, increase footfall, and
              promote your offers in real time.
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 mb-12">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <div className="text-center">
                ...
                <p className="opacity-90">Keep 100% of your revenue</p>
              </div>
              <div className="text-center">
                <CheckCircle className="w-12 h-12 mx-auto mb-4" />
                <h4 className="font-semibold mb-2">Free Subscription</h4>
                <p className="opacity-90">No monthly or annual fees (limited time)</p>
              </div>
              <div className="text-center">
                <Clock className="w-12 h-12 mx-auto mb-4" />
                <h4 className="font-semibold mb-2">Priority Visibility</h4>
                <p className="opacity-90"> Early partners get featured at the top</p>
              </div>
            </div>
          </div>
          ...
          <div className="text-center">
            ...
            >
              <Button
                size="lg"
                className="bg-white text-bogo-dark-600 hover:bg-gray-100 text-lg px-8 py-6"
              >
                List My Restaurant – For Free
                <ArrowRight className="ml-2 w-5 h-5" />
              </Button>
      ...
      {/* Join Us CTA */}
      <section className="relative py-0 text-white overflow-hidden">
            ...
            <div className="text-center lg:text-left">
              ...
              <div className="flex justify-center lg:justify-start gap-4 mt-4">
                ...
                <a
                  ...
                  className="bg-bogo-dark-500 rounded-lg px-3 py-1 flex items-center gap-2"
                  target="_blank"
                  rel="noopener noreferrer"
                >
